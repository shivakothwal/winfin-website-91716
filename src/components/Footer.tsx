      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="border-t border-primary-foreground/20 mt-6 pt-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-1 text-xs sm:text-sm text-primary-foreground/70">
            ...
            <a href="mailto:business@reviewrv25.com" className="text-accent hover:underline break-all font-semibold">
              business@reviewrv25.com
            </a>
            <span className="hidden sm:inline">|</span>
            <a href="tel:+918341105135" className="text-accent hover:underline whitespace-nowrap font-semibold">
              +91 8341105135
            </a>
            <span className="hidden sm:inline">|</span>
            <a 
